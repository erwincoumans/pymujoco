...
if _platform == "linux" or _platform == "linux2":
    ...
    CXX_FLAGS += '-DGLEW_STATIC '
    CXX_FLAGS += '/std:c++17 '
    #CXX_FLAGS += '-lmujoco210 '
    CXX_FLAGS += '-Lpython/win64 '
    os.environ['LDFLAGS'] = '-Lpython/win64 '
    my_data_files=["mujoco210.dll"]
...
extensions.append(pymujoco_ext)
...
setup(
    ...
    long_description=
    'Python bindings for MuJoCo',
    url='https://github.com/erwincoumans/pymujoco',
    ...
    #data_files ={'pymujoco': ['mujoco210.dll']}
